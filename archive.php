...
<?php if (have_posts()) : ?>
	<?php if (is_category()) { ?>
	<h3><?php printf( __( 'Archivos de la Categoría: %s', 'tw2' ), single_cat_title( '', false ) );?></h3>        
	<?php } elseif (is_tag()) { ?>
	<h3><?php printf( __( 'Archivos de la Etiqueta: %s', 'tw2' ), single_tag_title( '', false ) );?></h3>        
	<?php } elseif (is_day()) { ?>
	<h3><?php printf( __( 'Archivos del Día: %s', 'tw2' ), get_the_date() ); ?></h3>
	<?php } elseif (is_month()) { ?>
	<h3><?php printf( __( 'Archivos del Mes: %s', 'tw2' ), get_the_date( 'F Y' ) ); ?></h3>
	<?php } elseif (is_year()) { ?>
	<h3><?php printf( __( 'Archivos del Año: %s', 'tw2' ), get_the_date( 'Y' ) ); ?></h3>
	<?php } ?>
